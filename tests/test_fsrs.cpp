...
{
    std::cout << "--test: RepeatDefaultArg\n\n";
...
{
    std::cout << "--test: ReviewLogSerialize\n\n";
...
{
    std::cout << "--test: CustomSchedulerArgs\n\n";
